...
Another inspiration is Stephen Wolfram's /A New Kind of Science/[fn:1]. Here the simplest rules, Cellular Automata, are described and explored (esp. chapter 3). 
** Goals
The goal is to let the audience explore the patterns and flows that simple
rules can create. 
** Implementation
* Footnotes
[fn:1] Stephen Wolfram, "A New Kind of Science," (Wolfram Media, 2002), [[http://www.wolframscience.com/nksonline/toc.html][Online here]]
